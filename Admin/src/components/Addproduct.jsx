    ...
    return (
        <div className='p-8 box-border bg-white w-full rounded-sm mt-4 lg:m-7'>
            ...
            <div className='mb-3 flex items-center gap-x-4'>
                ...
                <select value={productDetails.category} onChange={changeHandler} name="category" id="" className='bg-primary ring-1 ring-slate900/20 medium-16 rounded-sm outline-none'>
