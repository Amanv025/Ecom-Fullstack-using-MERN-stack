    ...
    <section className="max_padd_container py-12 xl:py-28">
      <div>
        ...
        <div className="flexBetween my-8 mx-2">
          ...
          <div className="flexBetween max-sm:p-4 gap-x-4 px-8 py-3 rounded-5x1 ring-1 ring-slate-900/15">
            Sort by <MdOutlineKeyboardArrowDown />
          </div>
        </div>

        <div className="grid grid-cols-1  xs:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 xl:px-4 gap-6 ">
