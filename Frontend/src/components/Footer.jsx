...
const Footer = () => {
  return (
    <footer className="flexCenter pb-14 pt-20">
      <div className="max_padd_container flex w-full flex-col gap-14">
        <div className="flex flex-col justify-center gap-[10%] md:flex-row">
          <Link to="/" className="mb-10 bold-22 pl-2">
            SAAMAN
          </Link>
        ...
        <p className="text-center regular-14 text-gray-30 py-23">
          {" "}
          2024 SAAMAN | All rights reserved
        </p>
      </div>
    </footer>
  );
